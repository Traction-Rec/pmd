...
keywords: Documentation, ApexDoc, ApexRecDoc
language: Apex
---
...
**This rule is defined by the following Java class:** [net.sourceforge.pmd.lang.apex.rule.documentation.ApexRecDocRule](https://github.com/pmd/pmd/blob/master/pmd-apex/src/main/java/net/sourceforge/pmd/lang/apex/rule/documentation/ApexRecDocRule.java)
...
**Use this rule by referencing it:**
``` xml
<rule ref="category/apex/documentation.xml/ApexRecDoc" />
```
