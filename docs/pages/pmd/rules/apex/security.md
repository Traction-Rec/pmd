...
keywords: Security, ApexBadCrypto, ApexCRUDViolation, ApexCSRF, ApexDangerousMethods, ApexInsecureEndpoint, ApexOpenRedirect, ApexSharingViolations, ApexRecSharingViolations, ApexRecSystemDebugRestriction, ApexRecRestrictExtendingException, ApexRecRestrictDatabaseUsage, ApexSOQLInjection, ApexSuggestUsingNamedCred, ApexXSSFromEscapeFalse, ApexXSSFromURLParam
language: Apex
---
...
## ApexRecRestrictDatabaseUsage

**Since:** PMD 6.11.0

**Priority:** High (1)

Detect classes that inappropriately use DML instead of UnitOfWork

**This rule is defined by the following Java class:** [net.sourceforge.pmd.lang.apex.rule.security.ApexRecRestrictDatabaseUsageRule](https://github.com/pmd/pmd/blob/master/pmd-apex/src/main/java/net/sourceforge/pmd/lang/apex/rule/security/ApexRecRestrictDatabaseUsageRule.java)
...
|cc\_remediation\_points\_multiplier|1|Code Climate Remediation Points multiplier|no|
|cc\_block\_highlighting|false|Code Climate Block Highlighting|no|
|classesAllowedDatabaseAccessCsv||CSV of names of classes allowed database access.|no|
|unrestrictedDatabaseMethodsCsv||Database methods that are not restricted.|no|

**Use this rule by referencing it:**
``` xml
<rule ref="category/apex/security.xml/ApexRecRestrictDatabaseUsage" />
```

## ApexRecRestrictExtendingException

**Since:** PMD 6.11.0

**Priority:** High (1)

Detect classes that inappropriately extend Exception instead of TrecException

**This rule is defined by the following Java class:** [net.sourceforge.pmd.lang.apex.rule.security.ApexRecRestrictExtendingExceptionRule](https://github.com/pmd/pmd/blob/master/pmd-apex/src/main/java/net/sourceforge/pmd/lang/apex/rule/security/ApexRecRestrictExtendingExceptionRule.java)
...
**Use this rule by referencing it:**
``` xml
<rule ref="category/apex/security.xml/ApexRecRestrictExtendingException" />
```

## ApexRecSharingViolations

**Since:** PMD 6.11.0

**Priority:** Medium (3)

Detect classes declared without explicit sharing mode.

**This rule is defined by the following Java class:** [net.sourceforge.pmd.lang.apex.rule.security.ApexRecSharingViolationsRule](https://github.com/pmd/pmd/blob/master/pmd-apex/src/main/java/net/sourceforge/pmd/lang/apex/rule/security/ApexRecSharingViolationsRule.java)
...
**Use this rule by referencing it:**
``` xml
<rule ref="category/apex/security.xml/ApexRecSharingViolations" />
```

## ApexRecSystemDebugRestriction

**Since:** PMD 6.11.0

**Priority:** Medium (3)

Detect classes that call System.debug which could leak sensitive info to the client

**This rule is defined by the following Java class:** [net.sourceforge.pmd.lang.apex.rule.security.ApexRecSystemDebugRestrictionRule](https://github.com/pmd/pmd/blob/master/pmd-apex/src/main/java/net/sourceforge/pmd/lang/apex/rule/security/ApexRecSystemDebugRestrictionRule.java)
...
**Use this rule by referencing it:**
``` xml
<rule ref="category/apex/security.xml/ApexRecSystemDebugRestriction" />
```
