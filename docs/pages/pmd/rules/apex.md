...
*   [ApexRecDoc](pmd_rules_apex_documentation.html#apexrecdoc): This rule validates that: ApexDoc comments are present for classes, methods, and properties that ...
...
*   [ApexRecRestrictDatabaseUsage](pmd_rules_apex_security.html#apexrecrestrictdatabaseusage): Detect classes that inappropriately use DML instead of UnitOfWork
*   [ApexRecRestrictExtendingException](pmd_rules_apex_security.html#apexrecrestrictextendingexception): Detect classes that inappropriately extend Exception instead of TrecException
*   [ApexRecSharingViolations](pmd_rules_apex_security.html#apexrecsharingviolations): Detect classes declared without explicit sharing mode.
*   [ApexRecSystemDebugRestriction](pmd_rules_apex_security.html#apexrecsystemdebugrestriction): Detect classes that call System.debug which could leak sensitive info to the client
